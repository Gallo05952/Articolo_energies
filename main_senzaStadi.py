from Funzioni import InserimentoComposizione, Colonna, AspenHYSYS, CambioPressione
import numpy as np
import time
import math
import json
    ...
    for Temp in T:   
        for RRs in RR:
            for p in Pressure:
                ...
                data.append({"Q_Condenser": QCond,"Q_Reboiler":Qreb,"Composizioni Finali":Composizione, "Temperature":T_in,"Reflux Ratio":RRs,"Pressione":p, "Distillato":Distillato,"Comp iniziale":comp,"CompBott":ComposizioneBottom,"Q Comp":Q_Comp_BG,"W Comp":W_Comp_BG})
